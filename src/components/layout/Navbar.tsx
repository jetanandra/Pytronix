...
import { Menu, X, ShoppingCart, Sun, Moon, ChevronDown, Search, LogOut, User, Shield } from 'lucide-react';
          ...
          >
            <form className="relative rounded-lg shadow-sm" onSubmit={handleSearch}>
              <input
                ...
                className="w-full pl-4 pr-10 py-2 bg-white dark:bg-light-navy border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-neon-blue"
                autoFocus
                value={searchValue}
